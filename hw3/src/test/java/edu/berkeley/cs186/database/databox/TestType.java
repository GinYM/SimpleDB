...
public class TestType {
  ...
  public void testBoolType() {
    ...
    ByteBuffer buf = ByteBuffer.wrap(boolType.toBytes());
  ...
  public void testIntType() {
    ...
    // Check toBytes and fromBytes.
    ByteBuffer buf = ByteBuffer.wrap(intType.toBytes());
  ...
  public void testFloatType() {
    ...
    // Check toBytes and fromBytes.
    ByteBuffer buf = ByteBuffer.wrap(floatType.toBytes());
  ...
  public void testOneByteStringype() {
    ...
    // Check toBytes and fromBytes.
    ByteBuffer buf = ByteBuffer.wrap(stringType.toBytes());
